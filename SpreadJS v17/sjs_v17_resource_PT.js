var custom_resource = {
  ...
  "ReportSheet": {
    ...
    "configDataSetting": "Por favor, configure as configurações de dados.",
  ...
  "Functions": {
    ...
    "IFS": {
      "description": "Esta função verifica se uma ou mais condições foram atendidas e retorna um valor que corresponde à primeira condição VERDADEIRA.",
      "parameters": [
        {
          "name": "teste_lógico1"
        },
    ...
    "LET": {
      "description": "Esta função atribui resultados de cálculos a nomes. Útil para armazenar cálculos e valores intermediários definindo nomes dentro de uma fórmula. Esses nomes só se aplicam dentro do escopo da função LET.",
      "parameters": [
        {
          "name": "nome1"
        },
