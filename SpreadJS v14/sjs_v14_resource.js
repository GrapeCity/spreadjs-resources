var custom_resource = {
    "AutoMerge": {
        "Exp_RangeIsIntersected": "The range should not intersect with existing ranges."
    },
    "Bindings": {
    ...
    "ContextMenu": {
        ...
        "hideRows": "Hide",
        "hideSheet": "Hide",
        "hideSheetFailureInfo": "A workbook must contain at least one visible worksheet. To hide, delete or move the selected sheet(s), you must first insert a new sheet or unhide a sheet that is already hidden.",
    ...
    "Functions": {
        ...
        "OBJECT": {
            ...
            "parameters": [
                {
                    "name": "property1|properties_range1"
                },
                {
                    "name": "expression1|expressions_range1"
                },
                {
                    "name": "property2|properties_range2"
                },
                {
                    "name": "expression2|expressions_range2"
                },
                {
                    "name": "..."
                }
    ...
    "Pivot": {
        ...
        "ByJoiner": "by",
        "Cancel": "Cancel",
        "ChooseType": "Choose the type of calculation that you want to use summarize data from the selected field",
        ...
        "PivotPanel_DropDownList_Col": "Move to ColumLabels",
        ...
        "PivotPanel_Fields_MoveTo_RowLabel": "Add to Rows Labels",
...
// Added this line in order to import with NodeJS
